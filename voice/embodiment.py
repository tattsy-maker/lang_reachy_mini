...
class Embodiment(FrameProcessor):
    ...
    async def process_frame(self, frame: Frame, direction: FrameDirection):
        ...
        # Speaking state is not decoration: the session runner waits on it
        # (goodbyes, the post-enrollment rebrief), robot or not. Disabled,
        # it was never set, so --no-robot runs never waited (2026-09-23).
