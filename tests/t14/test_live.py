...
def test_two_visits_over_the_cloud_voice(paths, tmp_path, run_agent_say):
    ...
    log, found = run_agent_say(
        ["Hi! Yes, please remember me. I'm Sunita, I speak English and want "
         "Spanish, explain in English, beginner, just for conversation, I "
         "have ten minutes for small talk, and correct every mistake.",
         "Bye for now!"],
