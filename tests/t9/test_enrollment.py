...
def test_unknown_face_enrolls_by_voice(paths, tmp_path, run_agent_say):
    clip = paths.fixtures / "video" / "sunita_clip.avi"
    root = tmp_path / "learners"
    # T13.1 made enrollment an interview and T17.4 enforces every answer
    # (nine fields, recorded through intake_answer), so the scripted
    # visitor volunteers them all in one breath, then confirms once.
    log, found = run_agent_say(
        ["Hello there! I'd love to learn some Spanish.",
         "Yes please, remember me! My name is Sunita. I speak English and "
         "want Spanish, explain in English, I'm a beginner, just for fun "
         "with friends, I have ten minutes for small talk, and please "
