...
def test_stranger_briefing_is_a_four_question_script(tmp_path):
    ...
    assert "one question per turn" in text        # T17.4 wording
...
# T17.4: the interview order is name, language, own language and
# explain-in, level, goal, minutes and today, corrections -- one per turn.
INTERVIEW = [
    "Hello! I'd like to learn some Spanish.",
    "Yes please, remember me. My name is Sunita.",
    "Spanish.",
    "English is my language; explain in English please.",
    "I'd say intermediate.",
    "I'm preparing for job interviews in Madrid.",
    "About ten minutes; interview small talk.",
    "Correct every mistake, please.",
]
